...
public class WorldGenerator : MonoBehaviour
{
    ...
    [Range(32, 4096)] public int worldSize = 2048;              //Загальний розмір світу в одиницях Unity.
    [Range(32, 2048)] public int meshResolution = 512;          // Полігони рельєфу. Більше значення = більш детальний ландшафт, але повільніше генерація і рендеринг.
    [Range(1f, 1000f)] public float heightScale = 100f;         // Множник висоти ландшафту.  (heightScale)
    public int seed = 42;                                       // Seed 
    ...
    private void OnValidate()
    {
        ...
        meshResolution = Mathf.Clamp(meshResolution, 32, 2048);
